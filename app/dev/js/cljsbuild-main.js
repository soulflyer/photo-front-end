...
photo_front_end.core._main = function() {
  ...
  photo_front_end.core.app.on("window-all-closed", function() {
    return cljs.core.not_EQ_.call(null, cljs.nodejs.process.platform, "darwin") ? photo_front_end.core.app.quit() : null;
  });
