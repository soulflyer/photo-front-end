...
return (new CustomEvent(event_name,(function (){var obj16049 = {"detail":data};
return obj16049;
})()));
} else {
...
var args16054 = [];
var len__7923__auto___16060 = arguments.length;
var i__7924__auto___16061 = (0);
while(true){
if((i__7924__auto___16061 < len__7923__auto___16060)){
args16054.push((arguments[i__7924__auto___16061]));

var G__16062 = (i__7924__auto___16061 + (1));
i__7924__auto___16061 = G__16062;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args16054.length)].join('')));
...
var f = (function (){var pred__16057 = cljs.core._EQ_;
var expr__16058 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__16057.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__16058))){
return ((function (pred__16057,expr__16058){
return (function (p1__16050_SHARP_){
return console.warn(p1__16050_SHARP_);
});
;})(pred__16057,expr__16058))
} else {
if(cljs.core.truth_(pred__16057.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__16058))){
return ((function (pred__16057,expr__16058){
return (function (p1__16051_SHARP_){
return console.debug(p1__16051_SHARP_);
});
;})(pred__16057,expr__16058))
} else {
if(cljs.core.truth_(pred__16057.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__16058))){
return ((function (pred__16057,expr__16058){
return (function (p1__16052_SHARP_){
return console.error(p1__16052_SHARP_);
});
;})(pred__16057,expr__16058))
} else {
return ((function (pred__16057,expr__16058){
return (function (p1__16053_SHARP_){
return console.log(p1__16053_SHARP_);
});
;})(pred__16057,expr__16058))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__16064){
var map__16067 = p__16064;
...
var opts = map__16067__$1;
var eval_fn = cljs.core.get.call(null,map__16067__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__16069_SHARP_);
});})(new_def))
);
...
return (function (p__16070){
var vec__16071 = p__16070;
var ky = cljs.core.nth.call(null,vec__16071,(0),null);
var v = cljs.core.nth.call(null,vec__16071,(1),null);
...
var args16074 = [];
var len__7923__auto___16077 = arguments.length;
var i__7924__auto___16078 = (0);
while(true){
if((i__7924__auto___16078 < len__7923__auto___16077)){
args16074.push((arguments[i__7924__auto___16078]));

var G__16079 = (i__7924__auto___16078 + (1));
i__7924__auto___16078 = G__16079;
continue;
} else {
}
break;
