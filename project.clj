(defproject photo-front-end "0.1.0-SNAPSHOT"
  ...
  :aliases {"descjop-help" ["new" "descjop" "help"]
            ...
            "descjop-uberapp-win32" ["shell" "cmd.exe" "/c" "electron-packager" "./app/prod" "photo-front-end" "--platform=win32" "--arch=ia32" "--electron-version=1.6.6"]
            }
  ...
  :cljsbuild {:builds {:dev-main {:source-paths ["src"]
                                  ...
                                  :compiler {:output-to "app/dev/js/cljsbuild-main.js"
                                             ...
                                             :pretty-print true
                                             :output-wrapper true}}
                       :dev-front {:source-paths ["src_front" "src_front_profile/photo_front_end_front/dev"]
                                   :incremental true
                                   :jar true
                                   :assert true
                       ...
                       :prod-main {:source-paths ["src"]
                                   ...
                                   :compiler {:output-to "app/prod/js/cljsbuild-main.js"
                                              ...
                                              :pretty-print true
                                              :output-wrapper true}}
                       :prod-front {:source-paths ["src_front" "src_front_profile/photo_front_end_front/prod"]
                                    :incremental true
                                    :jar true
                                    :assert true
